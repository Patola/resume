...
:imagesdir: imagens
:imagesoutdir: img
:version-pt-br: https://github.com/Patla/resume/resume-pt-br.asciidoc
:version-en-us: https://github.com/Patla/resume/README.asciidoc
...
[[summary]]
==== Summary
* Versatile **system administrator** and **developer** with decades of UNIX and Linux experience in big customers, with practical experience in servers, desktops, mobile and embedded devices.
...
* Knowledge and practice with **development boards** like ODROIDs from hardkernel, PCDuino, Orange and Banana Pi, Wandboard, Cubieboard and many others.
...
* I can administrate diverse **UNIX system environments** including planning for high availability (certified in HACMP for AIX and with experience in other HA systems).
...
[[trips]]
==== Travel Availability
* Available for both national and international trips with up to 6 months periods.
