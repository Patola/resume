...
* Experience in programming witb various general use libraries/packages such as libcurl, berkeley db, sqlite3, **redis**, rabbitmq, scrapy, gettext (for internationalization), mysql, postgresql, oracle, MS SQL Server.
